...
parser.add_argument('--json_file', type=str,default="D:\GitHub\superstar-auto-notes-generator\deepsaber-master\scripts\generation\generated\Red_Velvet_Bad_Boy_block_placement_ddc2_130000_0.33_1.0.dat")
parser.add_argument('--experiment_name', type=str,default="block_selection_new2")
parser.add_argument('--checkpoint', type=str, default="2150000")
...
parser.add_argument('--use_beam_search', default=True)
parser.add_argument('--open_in_browser', default=True)
